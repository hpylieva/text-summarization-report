...
\todo[inline, color=green!40]{Which metric we used, the best BLEU we had}

\subsection{Results}
\todo[inline, color=green!40]{What our model outputs , explain why result are 'not perfect'}
